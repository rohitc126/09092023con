...
namespace eSGBIZ.Controllers
{
    public class ConcreteController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult _ConcreteSpecimens_Data_List(string grade, DateTime fDate, DateTime tDate)
        {
        ...
        public ActionResult ConcreteSpecimenEdit(int Test_ID = 0)
        {
